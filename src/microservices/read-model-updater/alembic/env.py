...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        ...
        # Read Model Updater creates both source schemas (read-only views) and public_read schema
        # Note: We use public_read for the version table as this service owns that schema
        context.configure(
