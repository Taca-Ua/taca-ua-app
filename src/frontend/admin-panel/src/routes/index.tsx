...
export const router = createBrowserRouter([
  ...
  {
    path: '/geral/cursos',
    element: <ProtectedRoute requiredRole="admin_geral"><Cursos /></ProtectedRoute>,
  },
  {
    path: '/geral/cursos/:id',
    element: <ProtectedRoute requiredRole="admin_geral"><CursoDetail /></ProtectedRoute>,
  },
  {
  ...
  },
  {
    ...
    element: <ProtectedRoute requiredRole="admin_geral"><FormatosPontuacao /></ProtectedRoute>,
  },
  {
    path: '/geral/torneios',
  ...
  },
  {
    ...
    element: <ProtectedRoute requiredRole="admin_nucleo"><TeamDetailPage /></ProtectedRoute>,
  },
  {
    path: '/nucleo/jogos',
