    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-2xl font-bold text-teal-400 mb-4">TaçaUa</h3>
          ...
          {/* Social Media */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-teal-400">Redes Sociais</h4>
            <div className="flex flex-col space-y-3">
              ...
              >
                <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center group-hover:bg-teal-600 transition-colors">
              ...
              {/* Instagram Desporto AAUAV */}
              <a
                href="https://www.instagram.com/desportoaauav_/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-3 text-gray-300 hover:text-teal-400 transition-colors"
              >
